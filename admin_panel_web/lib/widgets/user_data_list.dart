...
class UserData extends DataTableSource {
  ...
  UserData(this.dataList, this.index);
  @override
  DataRow? getRow(int index) {
    return dataList[index]["name"] == "noresult"
        ...
        : DataRow(
            ...
            cells: [
              DataCell(SizedBox(width: 5, child: Text((index + 1).toString()))),
              DataCell(SizedBox(
                  child: Image.network(
      ...
      builder: (context, snapshotData) {
        ...
        if (snapshotData.connectionState == ConnectionState.waiting) {
          return PaginatedDataTable(
              ...
              source: UserData(searchResult, searchResult.length));
        }
        ...
        return PaginatedDataTable(
                        ...
                        if (value.isNotEmpty &&
                          ...
                          setState(() {
                            ...
                            ((dataList.where((element) => element["name"]
                                    .toString()
                                    .toLowerCase()
                                    .contains(value.toLowerCase()))).isEmpty ||
            ...
            source: searchResult.isNotEmpty
                ? UserData(searchResult, searchResult.length)
                : UserData(dataList, dataList.length));
      },
    );
  }
}
