...
class StartPredictionResult extends StatefulWidget {
  StartPredictionResult({super.key, this.predictionModel});

  PredictionModel? predictionModel;

  @override
  State<StartPredictionResult> createState() => _StartPredictionResultState();
}

class _StartPredictionResultState extends State<StartPredictionResult> {
  //Chi tiết địa điểm
